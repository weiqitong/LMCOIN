...
unlocked to sign the Lmcoin-Qt.app bundle.
...
allowing somebody to distribute a Lmcoin-Qt.app or lmcoin-qt-setup.exe with a valid
...
that the lmcoin-qt.exe file inside the installer had not been tampered with.
