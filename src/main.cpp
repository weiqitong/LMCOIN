...
#if defined(NDEBUG)
# error "Lmcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Lmcoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s LMC additional fees, %d delta bytes\n",
