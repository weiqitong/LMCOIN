...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lmcoin Core lmcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lmcoin transaction") + "\n" +
              "  lmcoin-tx [options] -create [commands]   " + _("Create hex-encoded lmcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lmcoin transaction
