...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/lmcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Lmcoin Core"),
     ...
     * override -datadir in the lmcoin.conf file in the default data directory
     * (to be consistent with lmcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
