...
#ifndef LMCOIN_QT_LMCOINUNITS_H
#define LMCOIN_QT_LMCOINUNITS_H
...
/** Lmcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LmcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LmcoinUnits(QObject *parent);

    /** Lmcoin units.
      @note Source: https://en.lmcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LMC,
...
typedef LmcoinUnits::Unit LmcoinUnit;

#endif // LMCOIN_QT_LMCOINUNITS_H
