...
#ifndef LMCOIN_TEST_SCRIPTNUM10_H
#define LMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Lmcoin Core 0.10.0, for cross-comparison.
 */
public:
