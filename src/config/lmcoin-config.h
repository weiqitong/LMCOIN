/* src/config/lmcoin-config.h.  Generated from lmcoin-config.h.in by configure.  */
/* src/config/lmcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LMCOIN_CONFIG_H

#define LMCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/lmcoin/lmcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lmcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lmcoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lmcoin"
