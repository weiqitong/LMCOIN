...
// Copyright (c) 2009-2012 The Lmcoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Lmcoin/$1-%s The Lmcoin/' %s"
REGEX_CURRENT= re.compile("%s The Lmcoin" % year)
