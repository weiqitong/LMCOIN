...
This document provides guidelines for internationalization of the Lmcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lmcoin_en.ts` remains unchanged.
