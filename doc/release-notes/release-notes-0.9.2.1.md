Lmcoin Core version 0.9.2.1 is now available from:

  https://lmcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LMC to 0.01 LMC
...
- Fix "Start lmcoin on system login"
