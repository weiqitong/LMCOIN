Lmcoin Core version 0.9.4 is now available from:

  https://lmcoin.org/bin/0.9.4/
...
this update is incompatible with the Lmcoin system and could lead to consensus
forks.

Lmcoin Core released binaries from https://lmcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lmcoin/+archive/ubuntu/lmcoin
- A third-party or self-compiled Lmcoin Core

upgrade to Lmcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
