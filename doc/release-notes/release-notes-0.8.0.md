Lmcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lmcoin/files/Lmcoin/lmcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lmcoin
...
New/changed settings (command-line or lmcoin.conf file)
--------------------------------------------------------
